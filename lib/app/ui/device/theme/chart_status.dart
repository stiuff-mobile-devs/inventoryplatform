...
class StatusChart extends StatelessWidget {
  ...
  int _getOpenedInventoryCount() {
    ...
    return inventories.where((inventory) {
      // "OLD CODE" return inventory.created_at != null && inventory.created_at.isAfter(thirtyDaysAgo);
      return inventory.created_at.isAfter(thirtyDaysAgo);
    }).length;
  }
  ...
  int _getClosedInventoryCount() {
    ...
    return inventories.where((inventory) {
      return inventory.updated_at.isAfter(thirtyDaysAgo) &&
