...
class ImageController extends GetxController {
  Future<List<String>> convertImagesToBase64(List<File?> imageFiles) async {
    ...
    for (File? imageFile in imageFiles) {
      if (imageFile == null) {
        debugPrint("Arquivo de imagem nulo.");
        continue;
      }
  ...
  Future<List<String>> convertBase64ToImages(List<String> base64Strings) async {
    ...
    try {
      ...
      for (int i = 0; i < base64Strings.length; i++) {
        ...
        final filePath =
            '${directory.path}/converted_image_${DateTime.now().millisecondsSinceEpoch}.jpg';
      ...
      debugPrint("Erro ao converter Base64 para imagem: $e");
    }
    return filePaths;
  }
}
